...
import com.llvision.security.service.MailService;
import com.llvision.security.service.UserService;
import com.llvision.security.service.dto.UserDTO;
import com.llvision.security.web.rest.vm.ManagedUserVM;
...
public class UserResource {
    ...
    public ResponseEntity createUser(@RequestBody ManagedUserVM managedUserVM) throws URISyntaxException {
        ...
        // Lowercase the user login before comparing with database
            ...
            if(!applicationProperties.getUserManage().getSelfService()){
    ...
    public ResponseEntity<UserDTO> updateUser(@RequestBody ManagedUserVM managedUserVM) {
        ...
        Optional<UserDTO> updatedUser = userService.updateUser(managedUserVM,managedUserVM.getPassword());
